 ...
 *
 * @mixin \FFI\CScalarPtr
 * @mixin \FFI\CPtr
 */
final class CScalarPtrPtr extends \FFI\CData implements \ArrayAccess
{
    /**
    ...
    */
    private function offsetGet($offset): \FFI\CScalarPtr
    {
    }
    ...
    * {@inheritDoc}
    * @deprecated This method is virtual and is used only for autocomplete in IDE
    * @param CData|\FFI\CScalarPtr $value
    * @param int $offset
    */
