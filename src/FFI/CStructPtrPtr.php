 ...
 *
 * @mixin \FFI\CStructPtr
 * @mixin \FFI\CPtr
 */
final class CStructPtrPtr extends \FFI\CData implements \ArrayAccess
{
    /**
    ...
    */
    private function offsetGet($offset): \FFI\CStructPtr
    {
    }
    ...
    * {@inheritDoc}
    * @deprecated This method is virtual and is used only for autocomplete in IDE
    * @param CData|\FFI\CStructPtr $value
    * @param int $offset
    */
